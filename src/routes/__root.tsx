  ...
  head: () => ({
    meta: [
      ...
      { title: "Mara Ellison — Independent Product Designer" },
      {
        name: "description",
        content:
          "Calm, considered interfaces for people who build carefully. Mara Ellison is an independent product designer for small teams.",
      },
      ...
      { property: "og:title", content: "Mara Ellison — Independent Product Designer" },
      {
        ...
        content:
          "Calm, considered interfaces for people who build carefully. Independent product design for small teams.",
      },
